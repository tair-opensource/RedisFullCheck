...
var Opts struct {
	...
	JobId              string `long:"jobid" default:"unknown" description:"used in metric, job id, useless for open source"`
	TaskId             string `long:"taskid" default:"unknown" description:"used in metric, task id, useless for open source"`
